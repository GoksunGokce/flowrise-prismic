    ...
    >
      ...
      <div className=" grid lg:grid-cols-3 grid-cols-1 gap-8 ">
        {Testimonials.map((item,index) => item && (
          <div key={index} className="border bg-white shadow-lg rounded-lg px-8 md:px-14 py-10 md:py16 grid  content-between">
            ...
            <div>
              <p className="text-base font-medium text-slate-600">{item.data.name} </p>
            </div>
          </div>
        </div>
